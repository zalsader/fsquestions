...
if __name__ == '__main__':
    ...
    ax.set_ylim([0,0.4])
    plt.text(dt.datetime.strptime('2015-08','%Y-%m').date(), 0.26, r'$n=1$')
    plt.text(dt.datetime.strptime('2015-08','%Y-%m').date(), 0.125, r'$n=2$')
    plt.text(dt.datetime.strptime('2015-08','%Y-%m').date(), 0.065, r'$n=5$')
    plt.text(dt.datetime.strptime('2015-08','%Y-%m').date(), 0.035, r'$n=10$')
    plt.margins(0)
    #plt.show()
